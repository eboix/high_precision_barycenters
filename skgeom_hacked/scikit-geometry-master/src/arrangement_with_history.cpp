...
////// Hmmmm.... Forget about this arrangement history for now?
////// Or use some sort of more clever hashing solution?
...
////void insert_segments_in_arr_with_history(Segment_Arrangement_2_with_history& arr, std::vector<Segment_2>& segs) {
////    CGAL::insert(arr, segs.begin(), segs.end());
////}

////void init_arrangement_with_history(py::module &m) {
////    py::module sub = m.def_submodule("arrangement_with_history");

////    py::class_<Segment_Arrangement_2_with_history>(sub, "Arrangement_with_history")
////        .def(py::init<>())
////        .def_property_readonly("orig_segments", [](Segment_Arrangement_2_with_history& s, Halfedge_handle& he) {
////          return skgeom::make_handle_iterator<py::return_value_policy::reference_internal, Curve_handle>(s.faces_begin(), s.faces_end());
////        }, py::keep_alive<0, 1>())
////        .def("insert_segments", &insert_segments_in_arr_with_history)
////    ;
